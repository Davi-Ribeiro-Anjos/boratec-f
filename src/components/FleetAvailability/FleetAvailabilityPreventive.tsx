...
interface FleetAvailabilityPreventiveProps {
    open: boolean;
    setOpen: any;
}
...
export const FleetAvailabilityPreventive = memo(
    function FleetAvailabilityPreventive({ open, setOpen }: FleetAvailabilityPreventiveProps) {

...
interface FleetAvailabilityStoppedProps {
    open: boolean;
    setOpen: any;
}
...
export const FleetAvailabilityStopped = memo(
    function FleetAvailabilityStopped({ open, setOpen }: FleetAvailabilityStoppedProps) {
